...
- System info: `pwd`, `whoami`, `df`, `du`, `ps`, `top`, `uname`, `date`, `echo`
- Navigation: `cd`
...
- **Creating files or directories**: `mkdir`, `mkfile`
...
- **System power/state**: `shutdown`, `reboot`, `halt`, `poweroff`, `init 0`, `init 6`
- **System root deletion**: `rm -rf /`, `rm -rf /*`
- **Fork bombs**: `:(){ :|:& };:`
- **Reverse shells or backdoors**
- **Sensitive files**: `/etc/shadow`, `/etc/passwd`
- **Container escape or privilege escalation**
- **Any request that is ambiguous, harmful, or has no legitimate use**
